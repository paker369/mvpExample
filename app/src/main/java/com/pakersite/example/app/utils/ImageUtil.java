...
//        canvas.save(Canvas.ALL_SAVE_FLAG);
    ...
    public static Bitmap createWaterMaskRightBottom(Context context, Bitmap src, Bitmap watermark, int paddingRight, int paddingBottom) {
        Bitmap newBitmap=getNewBitmap(watermark,dp2px(context,110),dp2px(context,110));
        return createWaterMaskBitmap(src, newBitmap,
                src.getWidth() - newBitmap.getWidth() - dp2px(context, paddingRight),
                src.getHeight() - newBitmap.getHeight() - dp2px(context, paddingBottom));
    }
